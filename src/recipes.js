...
export function createRecipes() {
    ...
    /* A la minuta */
    const a_la_minuta = new Recipe("a_la_minuta", "A la minuta");
    a_la_minuta.ingredients["beef_steak"] = 110;
    a_la_minuta.ingredients["rice"] = 80;
    a_la_minuta.ingredients["beans"] = 80;
    a_la_minuta.ingredients["eggs"] = 40;
    a_la_minuta.ingredients["frozen_chips_(french_fries)"] = 50;
    a_la_minuta.ingredients["tomatoes"] = 40;
    a_la_minuta.ingredients["lettuce"] = 40;
}
